...
const FRAG = [
  ...
  "  vec2 w = vec2(fbm(p*1.4 + 0.03*t), fbm(p*1.4 + vec2(3.1,1.7) - 0.035*t));",
  "  float amb = fbm(p*1.8 + 1.7*w);",
  "  vec3 dark = vec3(0.020,0.024,0.034) + pal(fract(hue+0.12)) * 0.16 * smoothstep(0.2,0.95,amb);",
